...
help:
	...
	@echo ""
	@echo "Build and Push:"
	@echo "  make build-and-push-ui      Build + push UI (requires VERSION=vX)"
	@echo "  make build-and-push-model   Build + push model (requires VERSION=vX)"
	@echo "  make build-and-push-all     Build + push both (requires VERSION=vX)"
	@echo ""
	@echo "Deploy:"
...
build-and-push-ui:
ifndef VERSION
	$(error VERSION is required. Usage: make build-and-push-ui VERSION=v1)
endif
...
ifndef VERSION
	$(error VERSION is required. Usage: make build-and-push-model VERSION=v1)
endif
...
build-and-push-all:
ifndef VERSION
	$(error VERSION is required. Usage: make build-and-push-all VERSION=v1)
endif
